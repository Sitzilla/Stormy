...
import com.evansitzes.stormy.weather.Current;
import com.evansitzes.stormy.weather.Day;
import com.evansitzes.stormy.weather.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 36.0764;
        final double longitude = -94.1608;
    ...
    private void getForcast(double latitude, double longitude) {
        String apiKey = "01f00e0a26cb06602caf2c142df336d2";
    ...
    public void startDailyActivity(View view) {
        ...
        intent.putExtra(DAILY_FORCAST, mForecast.getDailyForcast());
